...
python3 /u/abhinav/Projects/BoostingSpeech/train.py  --cell LSTM -log logs/lstm.log -train test -dev test -ckpt models/<model_name>_last.ckpt
...
# python3 boosting_train.py  --cell GRU -log logs/gru_boost.log -train train -dev dev -ss 11357 -s boost -bn 1 -bd boosting_models/1/
