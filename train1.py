...
import model1 
# DATA
labels = open("TEDLIUM_release1/test/stm/output_labels.txt","r")
...
data_y = labels.read()
data_x1 = np.transpose(data_x1, axes=[0, 2, 1])
data_x2 = np.transpose(data_x2, axes=[0, 2, 1])
#data_y = data_y
...
#data_y_len = np.zeros((11,25000), dtype=int)
'''
...
data_x1 = data_x1[:,0:2000,:]
data_x2 = data_x2[:,0:2000,:]
print (data_x1.shape, data_x2.shape)
print len(data_y)
data_y = data_y[0:2000]
print len(data_y)
#print (data_x1.shape, data_x2.shape, data_y.shape, data_y_len.shape)
